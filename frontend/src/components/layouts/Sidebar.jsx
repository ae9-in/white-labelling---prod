...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-teal-900 to-teal-950 min-h-screen">
      <div className="p-6">
        <h1 className="text-2xl font-bold text-white">Operations Hub</h1>
        <p className="text-sm text-teal-200 mt-1">Wholesale Management</p>
      </div>
